 ...
 * @file
 *
 * @ingroup RTEMSScoreSchedulerLlist
 *
 * @brief Inlined Routines Associated with the Manipulation of the
 * Linked List Priority-Based Scheduling Structures
 *
 * This inline file contains all of the inlined routines associated with
 * the manipulation of the Linked List priority-based scheduling structures.
 */
...
#ifndef _RTEMS_SCORE_SCHEDULERLLISTIMPL_H
#define _RTEMS_SCORE_SCHEDULERLLISTIMPL_H

#include <rtems/score/schedulerllist.h>
...
/**
 * @addtogroup RTEMSScoreSchedulerLlist
 *
 * @{
 */
 ...
 */
RTEMS_INLINE_ROUTINE Scheduler_Llist_Context *
  _Scheduler_Llist_Get_context( const Scheduler_Control *scheduler )
{
  return (Scheduler_Llist_Context *) _Scheduler_Get_context( scheduler );
}
 ...
 */
RTEMS_INLINE_ROUTINE bool _Scheduler_Llist_Priority_less_equal(
 ...
 */
RTEMS_INLINE_ROUTINE void _Scheduler_Llist_Insert(
  Chain_Control  *chain,
 ...
 */
RTEMS_INLINE_ROUTINE void _Scheduler_Llist_Extract(
 ...
 *
 * This kernel routine implements scheduling decision logic for the Llist scheduler.
 *
 ...
 */
RTEMS_INLINE_ROUTINE void _Scheduler_Llist_Schedule_body(
  const Scheduler_Control *scheduler,
  Thread_Control          *the_thread,
  bool                     force_dispatch
)
